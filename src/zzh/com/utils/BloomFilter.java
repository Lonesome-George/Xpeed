...
public class BloomFilter {
	...
	private static SimpleHash[] hash = new SimpleHash[seeds.length];
	
	private BloomFilter() {
		for (int i = 0; i < seeds.length; i++) {
			hash[i] = new SimpleHash(DEFAULT_SIZE, seeds[i]);
		}
	}
	...
	public static void main(String[] args) {
		...
		BloomFilter blFilter = BloomFilter.getInstance();
		blFilter.add(value);
		System.out.println(blFilter.contains(value));
	}
}
