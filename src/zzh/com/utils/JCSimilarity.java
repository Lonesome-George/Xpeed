 ...
 */
public class JCSimilarity extends TFIDFSimilarity {
	...
	public float coord(int overlap, int maxOverlap) {
		System.out.println("coord: overlap / (float) maxOverlap = " + overlap / (float) maxOverlap);
	...
	public float queryNorm(float sumOfSquaredWeights) {
		System.out.println("queryNorm: (1.0 / Math.sqrt(sumOfSquaredWeights)) = "
